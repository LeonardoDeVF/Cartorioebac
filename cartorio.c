...
int registro(){
	...
	printf("Digite o CPF a ser registrado: "); //coletando informação do usuário
	...
	file = fopen(arquivo, "w"); //cria o arquivo e o "w" serve para você escrever
	...
	file = fopen(arquivo, "a");
	fprintf(file, ",");
	fclose(file); //importante para por a vírgula
...
int consulta(){
	...
	if(file == NULL){
		printf("NÃO foi possivel consultar arquivo.\n");
	}
